...
6. https://www.lightningdesignsystem.com/ --Lightning design system 它包括一个可下载的框架，可以用于在你的项目中添加动画
...
- http://httparchive.org/ -- **Web 相关的统计信息**
...
## 官方文档、手册：
- https://www.iana.org/assignments/media-types/media-types.xhtml -- MIME type
...
- http://mobilehtml5.org/ -- html5 css3 兼容性总览表
...
- https://platform-status.mozilla.org/ -- Firefox Platform Status
- https://developer.microsoft.com/en-us/microsoft-edge/platform/status/ -- IE Platform Status
- https://www.chromestatus.com/features -- Chrome Platform Status

## HTML CSS 开发：
- https://en.bem.info/ -- CSS BEM 官网
